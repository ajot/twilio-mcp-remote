...
account_sid = os.getenv('MCP_TWILIO_ACCOUNT_SID')
auth_token = os.getenv('MCP_TWILIO_AUTH_TOKEN')
phone_from = os.getenv('MCP_TWILIO_PHONE_FROM')
default_phone_to = os.getenv('MCP_TWILIO_PHONE_TO')
